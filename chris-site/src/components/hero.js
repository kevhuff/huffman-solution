...
const Hero = () => {
  return (
    <div className="bg-gray-200 text-black h-screen flex flex-col justify-center items-center">
      ...
      <button className="bg-blue-300 text-black px-6 py-2 rounded-full font-bold">
        Learn More
      </button>
    </div>
  );
